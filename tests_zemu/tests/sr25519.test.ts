...
describe('SR25519', function () {
  test('get address sr25519', async function () {
    ...
    try {
      ...
      const app = newSubstrateApp(sim.getTransport(), 'HydraDX')
      ...
      const expected_address = '7JBhBDZwrKqvYFaj9dFKW38vo2o4diTbJUM5k2VTmbTwHMLj'
  ...
  test('show address sr25519', async function () {
    ...
    try {
      ...
      await sim.waitUntilScreenIsNot(sim.getMainMenuSnapshot(),50000)
